...
export const Facilities = (): React.JSX.Element => {
    ...
    const { register, handleSubmit, formState: { errors } } = useForm<FacilityNameForm>();
                            ...
                            <div className="text-center">
                                <div className="max-w-[400px] mx-auto mt-4 text-left">
                                    ...
                                    <form className="flex space-x-2" onSubmit={handleSubmit(onSubmit)}>
                                        <input type="text" placeholder="検索" { ...register('name', { required: '検索キーワードを入力してください。' }) } className="flex-1 border rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"  />
                                        <button type="submit" className="bg-pink-200 text-white px-4 py-2 rounded-md hover:bg-pink-500">検索</button>
                                    </form>
